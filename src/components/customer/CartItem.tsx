  ...
  return (
    <div className="flex gap-4 p-4 bg-white rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
      ...
      <div className="flex-1 min-w-0">
        <h4 className="font-semibold text-slate-900 truncate">{item.menuItem.name}</h4>
        ...
        <p className="text-sm text-slate-500">{formatPrice(unitPrice)} each</p>
        ...
        <div className="flex items-center justify-between mt-3">
          ...
          <div className="flex items-center gap-3">
            <span className="font-bold text-lg text-slate-900">{formatPrice(subtotal)}</span>
            <button
