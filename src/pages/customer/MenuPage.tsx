        ...
        <div className="max-w-5xl mx-auto px-4 py-5">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <h1 className="text-3xl font-bold bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent">Order from your table</h1>
              <p className="text-slate-500 mt-1 text-sm">Exquisite dishes, crafted for your pleasure</p>
            </div>
            <div className="flex items-center gap-3">
              <button
                onClick={refetch}
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full bg-gradient-to-r from-amber-500 to-amber-600 text-white text-xs font-semibold hover:from-amber-600 hover:to-amber-700 shadow-md hover:shadow-lg transition-all duration-200"
              >
          ...
          <div className="mt-5 relative">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500 transition-all duration-200"
            />
          </div>

          <div className="mt-4 flex flex-wrap gap-2.5 overflow-x-auto pb-2">
          ...
          <div className="p-6">
            ...
            <div className="flex items-center justify-between mb-6 pt-4 border-t border-slate-100">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg font-semibold w-8 text-center text-slate-900">{quantity}</span>
                <button
